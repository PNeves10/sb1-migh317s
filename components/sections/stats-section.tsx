...
const stats: Stat[] = [
  { value: '2.4', suffix: 'B+', label: 'Em Ativos Digitais Transacionados' },
  { value: '15', suffix: 'K+', label: 'Transações Bem-Sucedidas' },
  { value: '95', suffix: '%', label: 'Satisfação dos Clientes' },
  { value: '48', suffix: 'H', label: 'Tempo Médio de Fecho de Negócio' },
];
