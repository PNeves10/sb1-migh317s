        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            <Badge variant="outline" className="px-4 py-2 text-sm bg-white/50 backdrop-blur-sm border-blue-200">
              ...
              AI-Powered Digital M&A Platform
            </Badge>
          </motion.div>
          ...
          >
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight">
              Buy, Sell & Value
              <span className="block text-gradient">Digital Assets</span>
          ...
          >
            The world's first AI-powered platform for digital mergers and acquisitions. 
            Get instant valuations, smart matchmaking, and seamless transactions for websites, 
            SaaS products, and digital businesses.
          </motion.p>
          ...
          >
            <div className="flex flex-col sm:flex-row gap-4 max-w-2xl mx-auto">
              <div className="relative flex-1">
                ...
                <Input
                  placeholder="Search for digital assets... (e.g., SaaS, E-commerce, Domains)"
          ...
          >
            <div className="text-center">
              ...
              <h3 className="font-semibold text-slate-700 mb-2">Secure Transactions</h3>
              <p className="text-slate-500 text-sm">End-to-end encryption and escrow protection</p>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center w-12 h-12 bg-emerald-100 rounded-full mx-auto mb-4">
                <Zap className="w-6 h-6 text-emerald-600" />
              </div>
              <h3 className="font-semibold text-slate-700 mb-2">AI Valuations</h3>
              <p className="text-slate-500 text-sm">Get instant, accurate asset valuations</p>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center w-12 h-12 bg-indigo-100 rounded-full mx-auto mb-4">
                <Users className="w-6 h-6 text-indigo-600" />
              </div>
              <h3 className="font-semibold text-slate-700 mb-2">Smart Matching</h3>
              <p className="text-slate-500 text-sm">Connect with the right buyers and sellers</p>
            </div>
          </motion.div>
        </div>
      </div>
