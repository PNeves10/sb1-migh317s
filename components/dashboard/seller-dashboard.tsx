          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Latest buyer interest in your assets
                </CardDescription>
              </CardHeader>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-sm text-slate-600 mb-2">Average AI Score</p>
                  <Progress value={82} className="h-2" />
                  <p className="text-xs text-slate-500 mt-1">Above market average</p>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-emerald-600 mb-2">2.8%</div>
                  <p className="text-sm text-slate-600 mb-2">Inquiry Rate</p>
                  <Progress value={65} className="h-2" />
                  <p className="text-xs text-slate-500 mt-1">Industry benchmark: 2.1%</p>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-amber-600 mb-2">24 days</div>
                  <p className="text-sm text-slate-600 mb-2">Avg. Time to Sale</p>
                  <Progress value={75} className="h-2" />
                  <p className="text-xs text-slate-500 mt-1">Faster than average</p>
                </div>
              </div>
            </CardContent>
          </Card>
                ...
                <CardContent className="p-6">
                  <div className="mb-4">
                    ...
                    <div className="flex items-center justify-between text-sm text-slate-600">
                      ...
                      <span>Listed {new Date(asset.listed).toLocaleDateString()}</span>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Monthly views across all assets
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="text-center p-4 bg-slate-50 rounded-lg">
                  ...
                  <div className="text-xs text-emerald-600 mt-1">+0.8% vs last month</div>
                </div>
                <div className="text-center p-4 bg-slate-50 rounded-lg">
                  <div className="text-2xl font-bold text-slate-900 mb-1">$89K</div>
                  <div className="text-sm text-slate-600">Avg. Sale Price</div>
                  <div className="text-xs text-blue-600 mt-1">Above market avg</div>
                </div>
                <div className="text-center p-4 bg-slate-50 rounded-lg">
                  <div className="text-2xl font-bold text-slate-900 mb-1">18</div>
                  <div className="text-sm text-slate-600">Days to First Inquiry</div>
                  <div className="text-xs text-amber-600 mt-1">Industry: 24 days</div>
                </div>
                <div className="text-center p-4 bg-slate-50 rounded-lg">
                  <div className="text-2xl font-bold text-slate-900 mb-1">4.8</div>
                  <div className="text-sm text-slate-600">Seller Rating</div>
                  <div className="text-xs text-purple-600 mt-1">Based on 12 reviews</div>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="inquiries" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage buyer inquiries and communications
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {recentInquiries.concat([
                  {
                    ...
                    buyer: 'Emma Wilson',
                    asset: 'Recipe Blog Network',
                    message: 'Is the content creation team included in the sale?',
                    time: '2 days ago',
                  ...
                  },
                  {
                    ...
                    buyer: 'Michael Brown',
                    asset: 'TaskFlow SaaS',
                    message: 'What is the customer churn rate and retention metrics?',
                    time: '3 days ago',
